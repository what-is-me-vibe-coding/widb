...
func TestBuildGroupKeySeparatorNoCollision(t *testing.T) {
	...
	colIdxMap := map[string]int{"col1": 0, "col2": 1}

	// 情况 1: col1="a|b", col2="c"
	row1 := map[string]common.Value{
		"col1": common.NewString("a|b"),
		"col2": common.NewString("c"),
	}
	groupBy1 := []Expression{
		&ResolvedColumnExpr{Name: "col1", Idx: 0, typ: common.TypeString},
