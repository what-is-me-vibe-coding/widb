...
| 文档 | 说明 |
|------|------|
| [doc/architecture.md](architecture.md) | 系统架构 |
| [doc/storage.md](storage.md) | 存储引擎详解 |
| [doc/query.md](query.md) | 查询引擎详解 |
| [doc/index.md](../.agent_plan/index.md) | 索引模块详解 |
| [doc/catalog.md](../.agent_plan/catalog.md) | 元数据管理详解 |
| [doc/common.md](../.agent_plan/common.md) | 公共模块详解 |
| [doc/api.md](api.md) | API 参考 |
